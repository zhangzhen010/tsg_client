  ...
  <div class="gacha-games">
    ...
    >
      ...
      >
        ...
        >
          <div v-if="item.id == 'tsg'" class="closebox">
            <p>The current card pool has not been listed yet, please wait!</p>
          </div>
...
.gacha-btn {
  ...
  border: transparent;
  cursor: pointer;
  font-family: 'Italic-variable', 'variable'!important;
}
